...
public class WTGUtil {
  ...
  public final Set<String> activityClassMethodSubSigs =
          activityClass.getMethods().stream().map(SootMethod::getSubSignature).collect(Collectors.toSet());
...
//  }
  ...
  /**
   * Specified through WTGspec (propagateIntent)
   * @param s
   * @return
   */
  ...
  /**
   * A general way to get information about data-flow propagation at a Stmt
   * @param s
   * @return
   */
