...
import com.research.nomad.markii.IAnalysis;
...
public class Configs {
  ...
  public static boolean runCustomAnalysis = false;
  public static IAnalysis customAnalysis = null;

  public static Set<String> debugCodes = Sets.newHashSet();

  public static Set<String> clients = Sets.newHashSet();

  public static boolean withSPARK = true;
